    ...
    */
    ...
    async function goUploadProfilePhoto(file){
      ...
      try{
        ...
        const holder=q('.go-profile-photo-preview');if(holder)holder.innerHTML=`<img id="go-profile-photo-preview" src="${esc(data.url||'')}" alt="Profile photo" style="width:104px;height:104px;min-width:104px;max-width:104px;max-height:104px;object-fit:cover;display:block;border-radius:50%">`;
