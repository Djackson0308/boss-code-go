    ...
    */
    ...
    async function goUploadProfilePhoto(file){
      ...
      try{
        ...
        const holder=$('go-profile-photo-visual')||q('.go-profile-photo-preview');if(holder){holder.innerHTML='';holder.style.setProperty('width','104px','important');holder.style.setProperty('height','104px','important');holder.style.setProperty('min-width','104px','important');holder.style.setProperty('min-height','104px','important');holder.style.setProperty('max-width','104px','important');holder.style.setProperty('max-height','104px','important');holder.style.setProperty('flex','0 0 104px','important');holder.style.setProperty('border-radius','50%','important');holder.style.setProperty('overflow','hidden','important');holder.style.setProperty('background-image',`url("${String(data.url||'').replace(/"/g,'&quot;')}")`,'important');holder.style.setProperty('background-size','cover','important');holder.style.setProperty('background-position','center','important');holder.style.setProperty('background-repeat','no-repeat','important');}
